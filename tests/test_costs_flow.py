...
# ---------------------------------------------------------------------------
# session_total_costs_by_addressee: per-addressee independence
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# _compute_step_bureaucracy_fractions: proportional allocation formula
# ---------------------------------------------------------------------------
...
def test_mixed_step_gets_proportional_fraction_half(session_id):
    """A step with one information obligation and one material regulation must
    receive 0.5 as its fraction, not 0."""
...
def test_step_without_information_duties_in_session_returns_empty_dict(session_id):
    """When the session has no information obligations at all, the function
    returns early with an empty dict."""
